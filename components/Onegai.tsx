          ...
          <div className="max-w-md">
            ...
            <div className="text-base text-left pb-4">
              <ul className="list-disc pl-6 pr-2">
                ...
                <li className="pb-2">
                  総選挙関連のハッシュタグで、特定のキャラや特定のキャラを推す方への批判・悪口を目的としたツイートは、ご遠慮下さいますようお願い致します
                </li>
                <li className="pb-2">
                  総選挙関連のハッシュタグで、カップリング要素を含むツイートは、公式程度の表現として頂けますと幸いです
                </li>
                <li className="pb-2">
                  なるべく制限は設けたくないと思いますが、多くの方にご参加頂いておりますため、ご理解とご協力を頂けますようお願い致します
                </li>
              </ul>
            </div>
          </div>
